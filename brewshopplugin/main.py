...
db = Chroma(persist_directory="./brewshop_chroma_db", embedding_function=embeddings)
...
async def privacy_policy():
    ...
    privacy_text = """
    Privacy Policy for the Brewshop API calls

Last Updated: 2023-11-18

1. Introduction

Welcome to the Brewshop API. We are committed to respecting your privacy and protecting your personal information. This Privacy Policy explains the types of information we collect through our API and how we use this information.

2. Information We Collect

The Brewshop API is designed to collect only the information that is necessary to provide our service. The only data we collect is:
